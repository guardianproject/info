...
aliases:
  ...
  - tracking
---
At a high level, it is easy say that "we know nothing". We do not log data or include analytics in our websites or applications. When we do operate servers to support our applications, they are configured to store as minimal data as possible, usually just a username and password, if that is required. We also only recommend third party services who abide by similar or compatible policies.

In some cases, when we must distribute our applications through services like Google Play, our hands our tied and you are at the mercy of their [terms and policies](https://play.google.com/about/play-terms.html). In some cases, convenience trumps privacy, but that is a decision that is up to you. You can always get our apps from our no logging, non-tracking, free and open-source app store, [F-Droid](/fdroid) or through our [Releases Folder](https://guardianproject.info/releases).

For some of our websites, we use our own self-hosted [Matomo Analytics](https://matomo.org) instance. Any identification of a user by IP address is limited to the country level, and no persistent cookies for tracking long term visitors are set.
